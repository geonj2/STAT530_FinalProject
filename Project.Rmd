...
author: \small{Geon Jang (geonj2), Jiaying (Tina) Wu, Jason (Zhendao) Li, Misael Lazaro Trigo (misaell2)}
output:
  pdf_document:
    toc: true
    toc_depth: 2
...
Gun contributed to data visualization, document formatting, and version control.
