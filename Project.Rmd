...
### Most likely will not need all these packages. 
...
### Tried other method to plot. Recommended.  
...
plotter(df1,c("I-5","I-6","I-9"))
plotter(df2,c("I-5","I-6","I-9"))

plot_grid(plotlist=plotter(df1,c("I-5","I-6","I-9")),ncol=2)
...
### Created Seurat and Spatial Data for both data. 
